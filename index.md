...
|----|----|----|----|
| Accidents by person | [`get_accidents()`](https://bonijoao.github.io/tidyprf/reference/get_accidents.md) | 1 row per person | 2007–2026 |
...
to see all variable descriptions in English or Portuguese.
